Las constantes son valores que no cambian durante la ejecución de un programa y se declaran de manera especial en cada lenguaje de programación, se consideran inmutables.
